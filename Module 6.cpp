...
namespace
{
    const char* const WINDOW_TITLE = "Chloe Ninefeldt - Module 6"; // Macro for window title
    ...
    //glm::vec3 gPositionPyramid(-2.0f, 0.0f, -5.0f);
...
void main()
{
    ...
    float ambientStrength = 2.0f;//0.1f; // Set ambient or global lighting strength
    ...
    float fillAmbientStrength = 0.01f; // Set ambient or global lighting strength
